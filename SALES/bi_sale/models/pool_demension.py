...
class PoolDimensionSale(models.Model):
    _name = "pool.dimension.sale"
    _description = "pool dimension sale"

    sale_pool_dimension_id = fields.Many2one(string='sale pool dimension id',comodel_name='sale.order')
