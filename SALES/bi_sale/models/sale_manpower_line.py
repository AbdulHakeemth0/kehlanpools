...
class SaleManpowerLine(models.Model):
    _name = "sale.manpower.line"
    _description = "Sale Manpower Line"

    sale_order_id = fields.Many2one(string='sale manpower line',comodel_name='sale.order')
